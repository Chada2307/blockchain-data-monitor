...
public class BlockEntity {
    ...
    public BlockEntity(BlockMetrics metrics) {
        this.blockHash = metrics.blockHash();
        this.blockNumber = metrics.blockNumber().longValue();
        this.txCount = metrics.transactionCount();
    }
